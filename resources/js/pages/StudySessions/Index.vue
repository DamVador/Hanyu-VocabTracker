                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="mb-6 flex items-center space-x-2">
                            <TextInput
                                ...
                                class="flex-grow"
                            />
                            <button v-if="search" @click="clearSearch" class="px-3 py-2 text-sm text-gray-500 hover:text-gray-700 rounded-md bg-gray-100 hover:bg-gray-200">
                                Clear
                            </button>
                        </div>

                        <div v-if="studySessions.length === 0" class="text-gray-600 italic mt-4">
