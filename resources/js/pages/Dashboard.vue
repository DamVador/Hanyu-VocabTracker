  ...
  <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 xl:max-w-screen-xl 2xl:max-w-screen-2xl">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
      ...
      <div class="flex flex-col gap-6 lg:order-1">
        <div class="bg-white p-6 sm:p-8 rounded-lg shadow-sm h-full"> <h3 class="text-xl sm:text-2xl font-semibold text-gray-800 mb-6">Study Progress</h3>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            ...
            <div class="bg-gray-50 p-4 rounded-md flex items-center justify-between col-span-1 sm:col-span-2">
              <div>
                ...
                <p class="text-2xl font-bold text-orange-600">{{ currentStreak }} <span class="text-base text-gray-500">days</span></p>
              </div>
      ...
      <div class="flex flex-col gap-6 lg:order-2">
        <div class="bg-white p-6 sm:p-8 rounded-lg shadow-sm h-full"> <h3 class="text-xl sm:text-2xl font-semibold text-gray-800 mb-6">Your Vocabulary</h3>
